...
m3=gam(count~s(stdforest)+years+offset(log(obs.hours)), data=nogo, family =nb(theta = NULL, link = "log"))
m4=gam(count~s(stdforest)+years+offset(log(obs.hours)), data=ssha, family =nb(theta = NULL, link = "log"))
